"""
       TWO CAMERAS (basler + ximea) + TREADMILL SPEED
"""
...
class SerialComm:
	...
	def read_arduino_write_to_file(self, xiCam_timestamp, bsCam_timestamp):
		...
		states["xiCam_timestamp"] = xiCam_timestamp
    states["bsCam_timestamp"] = bsCam_timestamp
